...
> 🚧 More servers land iteratively. Good candidates on the roadmap: `copilot-studio-mcp`, `ms-graph-mcp`, `azure-foundry-agents-mcp`. **PRs welcome** — see the [contribution guide](../CONTRIBUTING.md).
